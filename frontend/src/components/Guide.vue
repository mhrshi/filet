<template>
	...
	<main>
		...
		<v-container fill-height>
			<v-layout column>
				<div class="title pb-3">Student Dashboard</div>
				...
				<div id="branch-1-2" class="mt-4 subheading font-weight-medium">Remove submitted practical</div>
				<div class="body-1 pl-3 pt-3">
				...
				<div id="branch-1-3" class="mt-4 subheading font-weight-medium">Update practical</div>
				<div class="body-1 pl-3 pt-3">
				...
				<div class="title mt-5 pb-3">Faculty Dashboard</div>
				...
				<div id="branch-2-2" class="mt-4 subheading font-weight-medium">Filters</div>
				<div class="body-1 pl-3 pt-3">
				...
				<div id="branch-2-3" class="mt-4 subheading font-weight-medium">Inline practical view</div>
				<div class="body-1 pl-3 pt-3">
				...
				<div id="branch-2-4" class="mt-4 subheading font-weight-medium">Download practical(s)</div>
				<div class="body-1 pl-3 pt-3">
				...
				<div id="branch-2-5" class="mt-4 subheading font-weight-medium">Review mode</div>
				<div class="body-1 pl-3 pt-3">
				...
				branches: [
					{
						...
						children: [
							{ id: 1.1, name: 'Submit practical' },
							{ id: 1.2, name: 'Remove submitted practical' },
							{ id: 1.3, name: 'Update practical' }
						]
					},
					{
						id: 2,
						...
						children: [
							{ id: 2.1, name: 'Set/Reset deadline' },
							{ id: 2.2, name: 'Filters' },
							{ id: 2.3, name: 'Inline practical view' },
							{ id: 2.4, name: 'Download practical(s)' },
							{ id: 2.5, name: 'Review mode' }
						]
					}
				],
